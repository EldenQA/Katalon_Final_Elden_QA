...
WebUI.sendKeys(findTestObject('Administration/Manage_Hiring_Events/eventName'), 'Hiring Event' + EventName)

WebUI.click(findTestObject('Administration/Manage_Hiring_Events/startDataLocator'))

WebUI.click(findTestObject('Administration/Manage_Hiring_Events/currentDateLocator'))
