...
By actionIconDashboardBy = By.cssSelector('td:nth-of-type(6) > .btn-group button ')
...
for (int i = 0; i < buttonsOnDashboardSize; i) {
    ...
    if (attribute.equalsIgnoreCase('Candidates Count')) {
...
Assert.assertEquals(breadcrumbText, 'Home Candidate Details')
