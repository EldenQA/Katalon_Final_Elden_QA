...
WebUI.click(findTestObject('Administration/Manage_Microsite/deleteMicrosite'))

WebUI.click(findTestObject('Administration/Manage_Microsite/continueButtonOnDeletePopup'))

WebUI.verifyElementText(findTestObject('MTP Locators/successMessageLocator'), 'Microsite has been deleted successfully.')
