...
Input = ('Italian (IT)_' + RandomStringUtils.randomNumeric(6))
pro.setProperty('Template_Italian', Input)
...
WebUI.scrollToElement(findTestObject('Template Creation/Page_Mobile Talent  Mobile Recruitment/languageDropdownLocator'), 
    2)
...
for(WebElement languageElement: languageElements)
	
	{
	 ...
	 if(languageElementText.equalsIgnoreCase('Italian (IT)'))
	 {
