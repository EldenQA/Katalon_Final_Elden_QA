...
WebUI.callTestCase(findTestCase('P1 TestCases/Mobile Talent/ManageTemplate/Verify that user is successfully able to create the template(Portuguese (Brazil)'), 
...
Input = ('Campaign_Port_' + RandomStringUtils.randomNumeric(6))

pro.setProperty('Campaign_Port', Input)
...
for (WebElement ele : elements) {
    ...
    if (text.equalsIgnoreCase('Portuguese (Brazil)')) {
        ele.click()
...
keyValue = pro.getProperty('Template_Portuguese')
